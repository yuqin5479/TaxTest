...
import com.ruihua.geshuibao.Util.GestureUtils;
...
public class IosSwitch extends View implements View.OnClickListener {
    ...
    private int mBasePlaneColor = Color.parseColor("#128bed");//底盘颜色,布局描边颜色
    private int mOpenSlotColor = Color.parseColor("#128bed");//开启时手柄滑动槽的颜色
