...
/**
 * 我的申报-----月度专项附加扣除及其他扣除 列表界面 适配器
 */
public class MySpecialExpenseDeductionAdopter2 extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public MySpecialExpenseDeductionAdopter2(Context context, int listType) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_special_expense_deduction, parent, false);
