...
public class XmppConnection {
    ...
    public static String DEFAULT_PASSWORD = "240824aa0487bca3bdd4deb847954b76";//默认密码
//      测试环境
    public static String SERVER_HOST = "gsb-test.sruihua.com";// 服务器地址
    public static String SERVER_NAME = "gsb-test.sruihua.com";// 域
//      正式环境
//    public static String SERVER_HOST = "gsb-test.sruihua.com";// 服务器地址
//    public static String SERVER_NAME = "gsb-test.sruihua.com";// 域
